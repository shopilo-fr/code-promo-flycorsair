#!/usr/bin/env python3
"""
Recuperation des codes promo Corsair depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/flycorsair.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/flycorsair.com"
STORE_NAME = "Corsair"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Corsair depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-flycorsair)"
    }
    try:
